...
export default function SiteFooter() {
  return (
    <footer className="dark-section noise relative border-t border-white/[0.06] text-white">
      <div className="relative mx-auto max-w-6xl px-4 py-14">
        <div className="grid gap-10 md:grid-cols-4">
          <div>
            ...
            <p className="mt-3 text-xs text-white/30">
              Partners: Milestone &middot; Winsted &middot; Invenzi &middot; Altronix &middot; Automated Logic &middot; Velasea &middot; Magos &middot; Digital Watchdog
            </p>
          </div>
          <div>
        ...
        <div className="mt-12 flex flex-col gap-2 border-t border-white/[0.06] pt-6 text-xs sm:flex-row sm:justify-between">
          <span className="text-white/40">© {new Date().getFullYear()} COP&apos;S Electronics, S.A. Todos los derechos reservados.</span>
          <span className="text-white/30">Automatización &middot; Seguridad &middot; Energía</span>
        </div>
      </div>
    </footer>
  );
