      ...
      <div className="mx-auto max-w-6xl px-4 py-20">
        ...
        <div className="reveal-stagger mt-12 grid gap-5 md:grid-cols-3">
          {[
            ...
            <article key={x.n} className="reveal lg-card p-6">
              <p className="text-xs font-bold text-brand-400">{x.n}</p>
              <h3 className="mt-2 text-base font-semibold text-white">{x.t}</h3>
