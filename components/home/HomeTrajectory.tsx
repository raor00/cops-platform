      ...
      <div className="relative mx-auto max-w-6xl px-4 py-14">
        <div className="grid gap-10 lg:grid-cols-12 lg:items-stretch">
          <div className="lg:col-span-8">
            ...
            <div className="reveal mt-8 dark-glass-card p-6 md:grid md:grid-cols-12 md:gap-4">
          ...
          <div className="lg:col-span-4">
            <div className="reveal-stagger grid gap-4 sm:grid-cols-3 lg:grid-cols-1">
              <div className="reveal card-lift-dark dark-glass-card p-6"><p className="text-3xl font-bold tracking-tight text-white">28+</p><p className="mt-1 text-sm text-white/50">Años de trayectoria</p></div>
              <div className="reveal card-lift-dark dark-glass-card p-6"><p className="text-3xl font-bold tracking-tight text-white">1500+</p><p className="mt-1 text-sm text-white/50">Obras ejecutadas</p></div>
